...
export default function CheckDepartamento( {setDepartaments}) {
  ...
  const [departamentos, setDepartamentos ] = React.useState([
    ...
    {name:'El Paraiso',checked: false},
    {name:'Francisco Morazan',checked: false},
    {name:'Gracias a Dios',checked: false},
    {name:'Intibuca',checked: false},
    {name:'Islas de la Bahia',checked: false},
    {name:'La Paz',checked: false},
    {name:'Lempira',checked: false},
    {name:'Ocotepeque',checked: false},
    {name:'Olancho',checked: false},
    {name:'Santa Barbara',checked: false},
